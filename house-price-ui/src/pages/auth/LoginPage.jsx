      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          <SlideUp delay={200} duration={700} distance={24} className="transform">
            <form onSubmit={handleSubmit} className="bg-gray-300 w-full p-6 rounded-2xl shadow-2xl max-w-md mx-auto mr-1">
              ...
              <button type="button" className="w-full border py-2 rounded-lg mb-3 hover:bg-gray-50 transition bg-white ">
                Continue with Google
              </button>

              <button type="button" className="w-full border py-2 rounded-lg hover:bg-gray-50 transition bg-white">
